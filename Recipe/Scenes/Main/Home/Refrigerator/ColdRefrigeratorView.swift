...
/// Method
extension ColdRefrigeratorView {
    func setUI() {
...
#if DEBUG
import SwiftUI
struct ForColdRefrigeratorView: UIViewRepresentable {
    typealias UIViewType = UIView
    
    func makeUIView(context: Context) -> UIView {
        ColdRefrigeratorView()
    }
...
@available(iOS 13.0, *)
struct ColdRefrigeratorViewPreview: PreviewProvider {
    static var previews: some View {
        ForColdRefrigeratorView()
...
import SwiftUI
struct HomeViewControllerForColdView_preview: PreviewProvider {
    static var previews: some View {
