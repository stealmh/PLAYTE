...
class CommentTestItemCell: UITableViewCell {
    ...
    func addView() {
        addSubViews(myTitle, uploadTimeLabel, likeButton, declarationButton, comment, commentBackground, replyButton)
    }
    func configureLayout() {
        ...
        uploadTimeLabel.snp.makeConstraints {
            $0.top.height.equalTo(myTitle)
            $0.left.equalTo(myTitle.snp.right).offset(5)
            $0.width.greaterThanOrEqualTo(20)
        }
        
        likeButton.snp.makeConstraints {
            $0.top.equalTo(myTitle)
        ...
        commentBackground.snp.makeConstraints {
            $0.top.equalTo(myTitle).inset(20)
            $0.left.equalTo(myTitle)
